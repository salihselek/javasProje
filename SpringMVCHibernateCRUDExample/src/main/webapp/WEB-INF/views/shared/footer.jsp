...
<!-- DataTables -->
<script
	src="<c:url value="/template/bower_components/datatables.net/js/jquery.dataTables.min.js"/>"></script>
<script
	src="<c:url value="/template/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"/>"></script>
<!-- SlimScroll -->
<script
	src="<c:url value="/template/bower_components/jquery-slimscroll/jquery.slimscroll.min.js"/>"></script>
